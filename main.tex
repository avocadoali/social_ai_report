...
\title{Scene-aware and Social-aware Motion Prediction for Autonomous Driving}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Alfred Nguyen, Baris Sozudogru}
...
\input{sections/concept_overview.tex}
...
% \begin{center} \bfseries EDICS Category: 3-BBND \end{center}\begin{center} \bfseries EDICS Category: 3-BBND \end{center}\begin{center} \bfseries EDICS Category: 3-BBND \end{center}
% \fi
%
